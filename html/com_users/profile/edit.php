	...
	<div class="row">
		<div class="small-12 medium-10 large-8 columns">
			<form id="member-profile" action="<?php echo JRoute::_( 'index.php?option=com_users&task=profile.save' ); ?>" method="post"
				  class="form-validate form-horizontal formbg" enctype="multipart/form-data">
									...
									<?php else : ?>
										<div class="row">
											<div class="small-12 columns">
												...
												<!--												<span class="optional">-->
												<?php //echo JText::_( 'COM_USERS_OPTIONAL' ); ?><!--</span>-->
												<!--											--><?php //endif; ?>
						...
						<div class="control-group">
							<div class="control-label">
								<label id="jform_twofactor_method-lbl" for="jform_twofactor_method" class="hasTooltip"
									   title="<?php echo '<strong>' . JText::_( 'COM_USERS_PROFILE_TWOFACTOR_LABEL' ) . '</strong><br />' .
					...
					<fieldset>
						...
						<?php else : ?>
							<?php foreach ( $this->otpConfig->otep as $otep ) : ?>
								<span class="span3">
						<?php echo substr( $otep, 0, 4 ); ?>-<?php echo substr( $otep, 4, 4 ); ?>-<?php echo substr( $otep, 8, 4 ); ?>
